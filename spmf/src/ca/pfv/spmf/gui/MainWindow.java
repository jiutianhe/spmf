...
public class MainWindow extends JFrame {
    ...
    public static String SPMF_VERSION = "0.96q";
    // current input file
...
//				database.printDatabase();
                ...
                long startTime = System.currentTimeMillis();
                TransactionDatabaseConverter converter = new TransactionDatabaseConverter();
                converter.convert(inputFile, outputFile, Formats.SPMF_SEQUENCE_DB, transactionCount);
                long endTIme = System.currentTimeMillis();
                System.out.println("Sequence database converted.  Time spent for conversion = " + (endTIme - startTime) + " ms.");
            } else if ("Convert_transaction_database_to_sequence_database".equals(algorithmName)) {
                ...
                long startTime = System.currentTimeMillis();
                SequenceDatabaseConverter converter = new SequenceDatabaseConverter();
                converter.convert(inputFile, outputFile, Formats.SPMF_TRANSACTION_DB, sequenceCount);
                long endTIme = System.currentTimeMillis();
                System.out.println("Transaction database converted.  Time spent for conversion = " + (endTIme - startTime) + " ms.");
            }
            else if ("Generate_a_sequence_database".equals(algorithmName)) {
            ...
            }else if ("Calculate_stats_for_a_transaction_database".equals(algorithmName)) {
